    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0 font-size-18">Añadir Ingredientes a Producto</h4>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-9">
        <div class="card">
          <div class="card-body">
            <div class="">
              <form id="myForm" action="{{ route('ingredient.product.store') }}" method="post">
                @csrf
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <select name="producto_id" class="form-control select2" id="producto_id">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <select name="ingrediente_id" class="form-select select2" id="ingrediente_id">
                    <option value="" selected disabled>Seleccionar</option>
