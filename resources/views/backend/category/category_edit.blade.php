    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0 font-size-18">Editar Categoría</h4>
        </div>
      </div>
    </div>
                ...
                <div class="col-md-4">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <input name="nombre" type="text" class="form-control" value="{{ $category->nombre }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="mb-3">
                      <img id="showImage" src="{{ asset($category->imagen) }}" alt="Admin" width="170">
                    </div>
                  </div>
                </div>
              </div>
